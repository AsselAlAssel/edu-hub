...
export default async function Landing() {
	...
	// };
	// const url =
	// 	"https://vz-2e2ee02c-13c.b-cdn.net/d8aa79d5-7f62-4815-8265-07995ee06812/thumbnail_4ab4ae24.jpg";
	...
	// const createQuery = (APIKey: string, videoId: string) => {
	// 	const expired = Math.floor((new Date() as any) / 1000) + 3600;
	// 	const token = crypto
	// 		.createHash("sha256")
	// 		.update(APIKey + videoId + expired)
	// 		.digest("hex");
